    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (u.getRole() == 4) {
            ...
            for (Course x : CourseList) {
                ...
                List<Lesson> LessonList = LessonDAO.INS.loadLessonByCourseID(x.getCourseID());
                for (Lesson y : LessonList) {
                    UserDAO.INS.addDocProgress(u.getUserID(), y.getCourseID(), y.getLessonID());
                    UserDAO.INS.addQuizProgress(u.getUserID(), y.getCourseID(), y.getLessonID());
                }
            }
