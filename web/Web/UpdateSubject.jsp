<%-- 
    ...
    Created on : Jun 18, 2024, 5:32:59 AM
    Author     : hi2ot
--%>
            ...
            <div class="container-fluid py-5 col-lg-8">
                <div class="container py-5">
                    <div class="testimonial-header p-3">           
                        <input type="text" name="SubjectID" value="${sub.getSubjectID()}" hidden>
                        <h1 class="display-5 mb-5 text-dark text-center">Update Subject</h1>                        
                        <h3 class="fw-bold mb-3 py-2">Old Subject Name: </h3>                        
                        <input type="text" class="form-control border-2 border-secondary px-4 rounded-pill" value="${sub.getSubjectName()}" disabled>
                        <br/>
                        <h3 class="fw-bold mb-3 py-2">New Subject Name: </h3>                        
                        <input type="text" class="form-control border-2 border-secondary px-4 rounded-pill" name="SubjectName" value="" placeholder="Enter New Subject Name">
                        <br/>
