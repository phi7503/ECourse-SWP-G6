...
<%-- 
    ...
    Created on : May 30, 2024, 6:55:42 AM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">My Registrations</h1>
        </div>
                                    ...
                                    <td style="max-width: 50px">
                                        <c:forEach var="itemLessons" items="${item.getLessons()}">
                                            <div class="card mb-3">
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        <img src="${itemLessons.getImage()}" class="img-fluid rounded-start" alt="...">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            <h5 class="card-title">${itemLessons.getName()}</h5>
                                                            <p class="card-text"><small class="text-muted">${itemLessons.getCreatedDate()}</small></p>
                                                            <p class="card-text">Price: ${itemLessons.getPrice()}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
